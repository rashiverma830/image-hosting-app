...
const SignUp = () => {
    ...
    return (
        <div className="signin-page" style={{
            ...
            {/* Direct High-Resolution Wallpaper */}
            <img 
                src={welcomeBg} 
            ...
            <div style={{
                ...
                width: '100%',
                height: '100%',
                backgroundColor: 'rgba(10, 25, 50, 0.42)',
                zIndex: 2
            }} />
            ...
            <main className="signin-card" style={{
                position: 'relative',
                zIndex: 4,
                width: '100%',
                maxWidth: '440px',
                ...
                <form className="signin-form" onSubmit={(e) => e.preventDefault()}>
                    ...
                    <div className="form-actions" style={{ marginTop: '-5px' }}>
                        <label className="remember-me">
                            ...
                            <span>I agree to the processing of <a href="#" className="forgot-pwd" style={{ fontWeight: 500 }}>Personal data</a></span>
                        </label>
                    </div>
                ...
                <p className="signup-prompt">Already have an account? <Link to="/signin">Sign in</Link></p>
            </main>
        </div>
    );
};
